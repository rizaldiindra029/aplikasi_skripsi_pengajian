    ...
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td><?=$izin?> hari x Rp. <?=number_format($data->gaji)?></td>
            </tr>
            <tr>
                <th>Bpjs Kesehatan :</th>
                <td>Rp. <?=number_format((($absen * $data->gaji) - ($izin * $data->gaji))*1/100)?></td>
            </tr>
            <tr>
                <th>Bpjs Ketenagakerjaan :</th>
                <td>Rp. <?=number_format((($absen * $data->gaji) - ($izin * $data->gaji))*2/100)?></td>
            </tr>
            <tr>
                <th>Jumlah Cuti :</th>
                <td><?=$cuti?> hari x Rp. <?=number_format(0)?></td>
            </tr>
            <tr>
                <th>Jumlah Sakit :</th>
                <td><?=$sakit?> hari x Rp. <?=number_format(0)?></td>
            </tr>
            <tr>
